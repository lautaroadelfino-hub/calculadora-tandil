 ...
 * @param opciones        { periodo } — el mes que se liquida, "AAAA-MM". El motor
 *                        no lo usa para elegir nada (la escala y las tablas ya
 *                        vienen elegidas): lo expone en `metodo` para que el
 *                        recibo diga de qué mes es la cuenta. Hasta ahora la
 *                        pantalla lo tenía y no se lo pasaba.
 */
