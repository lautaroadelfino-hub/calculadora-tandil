...
export function procesarRecibo(convenio, datosEscala, valoresUsuario, paramsGanancias = null, opciones = {}) {
  ...
  const totalNoRemunerativoConIncidencia = noRemuFijo + antiguedadNR + presentismoNR + extraAdicionalesNR;
  const totalNoRemunerativo = totalNoRemunerativoConIncidencia + noRemuSinIncidencia;
  ...
  return {
    ...
    metodo: {
      ...
      noRemunerativoSinIncidencia: noRemuSinIncidencia,
