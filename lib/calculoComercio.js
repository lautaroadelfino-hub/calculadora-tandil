...
export function calcularComercio({
  ...
  // ——— Horas extras (no integran la base de vacaciones por “normal y habitual”)
  ...
  // ——— Remunerativos “comunes” del mes (SIN vacaciones todavía)
  ...
  const baseVacacionesRemNH = basico + antiguedad + presentismo + adicionalTitulo + adicionalFuncion;
  const valorDiaVac = baseVacacionesRemNH / 25; // LCT art. 155: dividir por 25
  const vacacionesMonto = vacacionesDias > 0 ? valorDiaVac * vacacionesDias : 0;
  ...
  return {
    ...
    valorDiaVac: +valorDiaVac.toFixed(4),
