...
export function calculoComercio({
  ...
  // NUEVO: cómo calcular la base de Obra Social
  ...
  const bases = {
    ...
    OS_48: (() => {
      ...
      return basico48 + antig48 + titulo48 + funcion48 + pres48; // pura base 48
    })(),
  };

  // -------- NUEVO: incluir extras + vacaciones en la base de OS si se pide
  const extrasYVacaciones = horasExtras50 + horasExtras100 + vacacionesPlus;
  const baseOS =
  ...
  const itemsDeduccion = [
    ...
    { label: `Obra social (3%)`,       monto: baseOS * 0.03,         base: baseOS, baseTag: (obraSocialBase === "48" ? "Base 48" : obraSocialBase === "real" ? "Remunerativo real" : "Base 48 + extras + vac") },
...
// mantener compatibilidad con import { calcularComercio }
export { calcularComercioV2 as calcularComercio };
export default calcularComercioV2;
