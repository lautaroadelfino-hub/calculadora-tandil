...
export const REGLAS_DE_CALCULO = {
  ...
  antiguedad: {
    descripcion:
      "Cuánto suma la antigüedad. Sobre el básico, salvo que el convenio diga " +
      "`basico_mas_adicionales`: Camioneros (ítem 6.1.5 del CCT 40/89) la calcula " +
      "sobre todos los conceptos remunerativos, o sea básico más adicionales.",
    campos: ["porcentaje_por_año", "modo", "tramos", "aplica_sobre"],
    anidado: { tramos: ["desde_años", "porcentaje"] },
    opcionesDe: { modo: ["tramos"], aplica_sobre: ["basico", "basico_mas_adicionales"] },
  },
  presentismo: {
  ...
  retenciones_sindicales: {
    descripcion:
      "Descuentos del gremio. La base `remunerativo_habitual` son los conceptos " +
      "mensuales normales y habituales (sin horas extras, SAC ni vacaciones): la " +
      "del tope del Decreto 612/26 para las cuotas solidarias.",
    porCada: [
      "label", "porcentaje", "valor_fijo", "base", "condicion",
      "reemplaza_obra_social", "depende_de", "cuando", "rubro",
    ],
    opcionesDe: {
      base: ["remunerativo", "remunerativo_habitual", "remunerativo_mas_no_remunerativo", "no_remunerativo"],
      condicion: ["siempre", "solo_afiliado", "solo_no_afiliado"],
    },
    // En qué rubro del costo laboral (Decreto 407/2026) cae la retención. Si no
    // se dice, "sindical", que es lo que son casi todas; el aporte fijo a la
    // obra social (OSECAC en Comercio) es "obra_social".
  ...
  contribuciones_convenio: {
    ...
    opcionesDe: { base: ["remunerativo", "remunerativo_mas_no_remunerativo", "basico"] },
  ...
  adicionales_por_unidad: {
    descripcion:
      "Conceptos que se pagan por día trabajado, por kilómetro, por viaje o por " +
      "mes, con el importe que fija cada planilla: la comida, el viático especial, " +
      "la pernoctada y los kilómetros de Camioneros. El IMPORTE vive en la escala " +
      "del período (`valores_del_periodo`, por su clave); la regla, en el convenio. " +
      "La cantidad la informa la persona en la pregunta `cantidad_de`. Los no " +
      "remunerativos van sin incidencia (viáticos del art. 106 LCT), salvo que la " +
      "regla diga `con_incidencia`.",
    porCada: ["label", "valor", "unidad", "naturaleza", "con_incidencia", "cantidad_de", "depende_de", "cuando"],
    opcionesDe: { unidad: ["dia", "km", "viaje", "mes"], naturaleza: ["remunerativo", "no_remunerativo"] },
  },
};
