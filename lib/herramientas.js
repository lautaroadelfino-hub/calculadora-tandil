...
export const HERRAMIENTAS = [
  {
    id: "empleador",
    nombre: "Panel Empleador",
    descripcion:
      "Calculá el costo laboral total de un puesto, con detalle de contribuciones, ART y otros aportes.",
    href: "/empleador",
...
//
//   const isPublico = id.includes("municipalidad") || ...
//   const isGastro  = id.includes("fehgra") || id.includes("utghra");
//
// Eso fallaba en silencio de dos formas. La primera: el id real del convenio
// gastronómico es "gastronomicos-cct-389-04", que no contiene ni "fehgra" ni
// "utghra" (que además está mal escrito: el sindicato es UTHGRA), así que su
// tarjeta ya caía al estilo genérico. La segunda, peor: un convenio municipal
// cuyo id no dijera "municipalidad" se etiquetaba "Sector privado" en la home,
// o sea información equivocada para el visitante.
//
...
export const SECTORES = [
  ...
  { value: "publico", label: "Sector público", color: "emerald" },
