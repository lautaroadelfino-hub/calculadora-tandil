...
// Devuelve SOLO publicadas para el frontend público (contrato: array simple)
...
await env.DB
.prepare('insert into news(date,title,url,tag,published) values(?,?,?,?,?)')
.bind(d, title, url || null, tag, published ? 1 : 0)
.run();
